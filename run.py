...
cl = LineClient(authToken='EAmL2Tt2W2juKvbLDbR9.EMgVa/eI6ZiPVVyfrJnCIq.Y8bKFGdBOn/Wp77hloTWGtfSfXYKNWB/ZDaZCHM0VRs=')
cl.log("Auth Token : " + str(cl.authToken))
channel = LineChannel(cl)
cl.log("Channel Access Token : " + str(channel.channelAccessToken))

ki = LineClient(authToken='EA1isP7RUBGAaJkL69z6.L3B9ZKLaNl92+jnx3kgSTG.CJYghOY2eOILexcmB3Im6cTDORxlr4+gT+vAbbzmJv0=')
ki.log("Auth Token : " + str(ki.authToken))
channel1 = LineChannel(ki)
ki.log("Channel Access Token : " + str(channel1.channelAccessToken))

kk = LineClient(authToken='EARIlWZVPzrBEcHKCFRf.wss8VHn4R4LcUm/cGii0JW.M2bxl7d9x9QZCswC4Tp9XqW1A/2vRuialPX2/Qzsq7I=')
kk.log("Auth Token : " + str(kk.authToken))
channel2 = LineChannel(kk)
kk.log("Channel Access Token : " + str(channel2.channelAccessToken))

kc = LineClient(authToken='EAqa0bg76gb2Y7LzlSy4.IfFaB67oG1G04TyymDQjva.uAyounRJ81+HdWOqzqbdZN0+5ZKkZPT8RGEm+7qxBfA=')
kc.log("Auth Token : " + str(kc.authToken))
channel3 = LineChannel(kc)
kc.log("Channel Access Token : " + str(channel3.channelAccessToken))

kc4 = LineClient(authToken='EALUP1Nab0fpEJW1PAcf.KQ7hBaKQhnSTql/YcmHuFW.LHsumw3hNpomAvq45m3tXfwt6VB1ptHU+eb2d9suhqI=')
kc4.log("Auth Token : " + str(kc4.authToken))
channel4 = LineChannel(kc4)
kc4.log("Channel Access Token : " + str(channel4.channelAccessToken))

kc5 = LineClient(authToken='EA1oUSdMSHdB32OYE8N2.OteV1+X4xKvwC2hP+yX+mG.X3qCMi2NSWh43Lgkw/WIdsr2zJbumwL/6/71moaoBos=')
kc5.log("Auth Token : " + str(kc5.authToken))
channel5 = LineChannel(kc5)
kc5.log("Channel Access Token : " + str(channel5.channelAccessToken))

kc6 = LineClient(authToken='EAw55r3ZK0kemLmnrTke.GH7Q5UoWHkWWz6qxVMV9pG.UNW8MKD4tSTkPZAwQsbZbHP8LREF739lDxTHUznfzuw=')
kc6.log("Auth Token : " + str(kc6.authToken))
channel6 = LineChannel(kc6)
kc6.log("Channel Access Token : " + str(channel6.channelAccessToken))

kc7 = LineClient(authToken='EA1C9Hq1cbeKVYv2Lyw4.eindM63fvMNPPOXWwUqNra.v0m6ihJ0uDuALh8XYac+iVQkIkcVgnG7S1J7bX3ZRd0=')
kc7.log("Auth Token : " + str(kc7.authToken))
channel7 = LineChannel(kc7)
kc7.log("Channel Access Token : " + str(channel7.channelAccessToken))

kc8 = LineClient(authToken='EAl5P8KB0NVSuPWVHtj5.cvyR0OZYc5KMPGflBSYibq.EiXWio++k4iMdnZTQu4nS8EnvLjfw00AYckSWib5aX0=')
...
poll = LinePoll(cl)
call = cl
creator = ["u7a61af03e122eb3229bef60546335c89","u6df56af7e77de751d6b39a3d9efdb578"]
owner = ["u7a61af03e122eb3229bef60546335c89","u6df56af7e77de751d6b39a3d9efdb578"]
admin = ["u7a61af03e122eb3229bef60546335c89","u6df56af7e77de751d6b39a3d9efdb578"]
staff = ["u7a61af03e122eb3229bef60546335c89","u6df56af7e77de751d6b39a3d9efdb578"]
...
KAC = [cl,ki,kk,kc,kc4,kc5,kc6,kc7,kc8]
ABC = [ki,kk,kc,kc4,kc5,kc6,kc7,kc8]
ppop = [ki,kk,kc,kc4,kc5,kc6,kc7,kc8]
Bots = [mid,Amid,Bmid,Cmid,C4mid,C5mid,C6mid,C7mid,C8mid]
Dpk = admin + staff
